        ...
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
          <div>
            <div className="flex items-center gap-2 mb-4">
              <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-brand-green text-white font-display text-xl font-bold">
                K
              </div>
              <div>
                <p className="font-display font-semibold">{STORE.name}</p>
                <p className="text-xs text-white/50">{STORE.location}</p>
              </div>
            </div>
