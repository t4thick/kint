...
export default function DeliveryPage() {
  return (
    <div className="mx-auto max-w-4xl px-4 py-12 sm:px-6 sm:py-16">
      <div className="mb-12">
        <h1 className="font-display text-4xl font-semibold text-brand-green">Delivery</h1>
      ...
      <section className="mb-12">
        <h2 className="font-display text-2xl font-semibold text-brand-green mb-6">Delivery Zones</h2>
        <div className="space-y-4">
          {DELIVERY_ZONES.map((zone) => (
            <div
              key={zone.id}
              className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 rounded-2xl border border-brand-border bg-white p-6"
            >
              <div>
              ...
              <div className="flex items-center gap-6 text-sm">
                <div className="text-center">
                  <p className="font-semibold text-brand-green">{formatPrice(zone.fee)}</p>
                  <p className="text-brand-muted text-xs">Delivery fee</p>
                </div>
                <div className="text-center">
                  <p className="font-semibold text-brand-terracotta">{zone.eta}</p>
      ...
      <section className="rounded-2xl border border-brand-border bg-brand-cream p-8 space-y-4">
        <h2 className="font-display text-xl font-semibold text-brand-green">How It Works</h2>
